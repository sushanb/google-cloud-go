...
func TestMetricsExporting(t *testing.T) {
	...
	pool, err := NewBigtableChannelPool(ctx, poolSize, strategy, dialFunc, nil, time.Now(), WithMeterProvider(provider), WithMetricsReporterConfig(btopt.DefaultMetricsReporterConfig()))
	if err != nil {
