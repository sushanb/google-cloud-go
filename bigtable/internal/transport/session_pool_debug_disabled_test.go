...
// contract of EnableClientDebug=false: with debugEnabled=false the pool
// records nothing on any allocating debug site. Drives the pool through
// several picker + latency + scaling paths and asserts the debug rings
// stay empty.
//
